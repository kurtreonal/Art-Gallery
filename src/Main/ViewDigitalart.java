...
public class ViewDigitalart extends JFrame {
    ...
    private void showImageDetails() {
        String[] details = artCollection.getDigitalArtDetails(imgLoop);
