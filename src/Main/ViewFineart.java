...
public class ViewFineart extends JFrame {
    ...
    public ViewFineart() {
        ...
        artCollection.loadFineArt(); // Load fine art images
        images = artCollection.getFineArt();
        initializeUI();
    }
    ...
    private void showImageDetails() {
        String[] details = artCollection.getFineArtDetails(imgLoop);
