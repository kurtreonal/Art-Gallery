...
public class ViewPainting extends JFrame {
    ...
    public ViewPainting() {
        ...
        artCollection.loadPaintings(); // Load painting images
        images = artCollection.getPaintings();
        initializeUI();
    }
    ...
    private void showImageDetails() {
        String[] details = artCollection.getPaintingDetails(imgLoop);
